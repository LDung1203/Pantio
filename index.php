...
<div id="content">
    <div class="style-div">
        <h1 class="style-font">BỘ SƯU TẬP</h1>
        <br>
        <img class="img-3que" src="img/3que.png">
    </div>
    <div class="img-items" style="flex-wrap: nowrap">
        <a href="" target="_blank" >
            <img class="img-border" src="img/bst1.png" alt="1" height="90%" width="90%"></img>
        </a>
        <a href="" target="_blank" >
            <img class="img-border" src="img/bst2.png" alt="1" height="90%" width="90%"></img>
        </a>
    </div>
    <! SALE>
    <div class="style-div">
        <h1 class="style-font">SẢN PHẨM SALE</h1>
        <br>
        <img class="img-3que" src="img/3que.png">
    </div>
    <div class="img-items">
        ...
        <div class="img-dis">
            ...
            <a href="" target="_blank" class = "img-name js-buy">Chân váy công sở dáng loe</a>
            <div class="gia_km_goc">
                <p class="gia_km">698,600₫</p>
                <p class="gia_goc">698,600₫</p>
            </div>
        ...
        <div class="img-dis">
                <img class="img-border js-buy" src="img/sale3.png" alt="1" height="400" width="300"></img>
            <a href="" target="_blank" class = "img-name">Quần công sở dáng suông</a>
            <div class="gia_km_goc">
                <p class="gia_km">698,600₫</p>
                <p class="gia_goc">698,600₫</p>
            </div>
        ...
        <div class="img-dis">
                <img class="img-border js-buy" src="img/sale4.png" alt="1" height="400" width="300"></img>
            <a href="" target="_blank" class = "img-name">Đầm công sở vải thô</a>
            <div class="gia_km_goc">
                <p class="gia_km">698,600₫</p>
                <p class="gia_goc">698,600₫</p>
            </div>
        ...
        <div class="img-dis">
                <img class="img-border js-buy" src="img/sale5.png" alt="1" height="400" width="300"></img>
            <a href="" target="_blank"   class = "img-name">Chân váy công sở vải thô</a>
            <div class="gia_km_goc">
                <p class="gia_km">698,600₫</p>
                <p class="gia_goc">698,600₫</p>
            </div>
        ...
        <div class="img-dis">
                <img class="img-border js-buy" src="img/sale6.png" alt="1" height="400" width="300"></img>
            <a href="" target="_blank" class = "img-name">Đầm công sở vải tuyp sy</a>
            <div class="gia_km_goc">
                <p class="gia_km">698,600₫</p>
                <p class="gia_goc">698,600₫</p>
            </div>
        ...
        <div class="img-dis">
                <img class="img-border js-buy" src="img/sale7.png" alt="1" height="400" width="300"></img>
            <a href="" target="_blank" class = "img-name">Quần công sở vải thô dáng suông</a>
            <div class="gia_km_goc">
                <p class="gia_km">698,600₫</p>
                <p class="gia_goc">698,600₫</p>
            </div>
        ...
        <div class="img-dis">
                <img class="img-border js-buy" src="img/sale8.png" alt="1" height="400" width="300"></img>
            <a href="" target="_blank" class = "img-name">Quần công sở vải tuyp sy dáng suông</a>
            <div class="gia_km_goc">
                <p class="gia_km">698,600₫</p>
                <p class="gia_goc">698,600₫</p>
            </div>
    ...
    <div class = "style-div">
        <a href="" target="_blank">
            <p style="font-family: Arial; font-size: 70%" class = "see-more" uppercase>Xem thêm</p>
        </a>
    </div>
    ...
    <! ĐỘC QUYỀN ONL>
    <div class="style-div">
        <h1 class="style-font">SẢN PHẨM ĐỘC QUYỀN ONLINE</h1>
        <br>
        <img class="img-3que" src="img/3que.png">
    </div>
    <div class="img-items">
        <div class="img-dis">
            <a href="" target="_blank">
                <img class="img-border" src="img/onl1.png" alt="1" height="400" width="300"></img>
            </a>
            <br>
            <a href="" target="_blank" class="img-name">Áo thun doạ phố vải cotton</a>
            <div class="gia_km_goc">
                <p class="gia_km">698,600₫</p>
                <p class="gia_goc">698,600₫</p>
            </div>
        ...
        <div class="img-dis">
            <a href="" target="_blank">
                <img class="img-border" src="img/onl2.png" alt="1" height="400" width="300"></img>
            </a>
            <br>
            <a href="" target="_blank" class="img-name">Quần short dạo phố vải thô</a>
            <div class="gia_km_goc">
                <p class="gia_km">698,600₫</p>
                <p class="gia_goc">698,600₫</p>
            </div>
        ...
        <div class="img-dis">
            <a href="" target="_blank">
                <img class="img-border" src="img/onl3.png" alt="1" height="400" width="300"></img>
            </a>
            <br>
            <a href="" target="_blank" class="img-name">Đầm thun dạo phố vải cotton</a>
            <div class="gia_km_goc">
                <p class="gia_km">698,600₫</p>
                <p class="gia_goc">698,600₫</p>
            </div>
        ...
        <div class="img-dis">
            <a href="" target="_blank">
                <img class="img-border" src="img/onl4.png" alt="1" height="400" width="300"></img>
            </a>
            <br>
            <a href="" target="_blank"   class="img-name">Đầm dạo phố vải thô</a>
            <div class="gia_km_goc">
                <p class="gia_km">698,600₫</p>
                <p class="gia_goc">698,600₫</p>
            </div>
        ...
        <div class="img-dis">
            <a href="" target="_blank">
                <img class="img-border" src="img/onl5.png" alt="1" height="400" width="300"></img>
            </a>
            <br>
            <a href="" target="_blank" class="img-name">Áo croptop dạo phố vải thô</a>
            <div class="gia_km_goc">
                <p class="gia_km">698,600₫</p>
                <p class="gia_goc">698,600₫</p>
            </div>
        ...
        <div class="img-dis">
            <a href="" target="_blank">
                <img class="img-border" src="img/onl6.png" alt="1" height="400" width="300"></img>
            </a>
            <br>
            <a href="" target="_blank" class="img-name">Quần dạo phố vai linen</a>
            <div class="gia_km_goc">
                <p class="gia_km">698,600₫</p>
                <p class="gia_goc">698,600₫</p>
            </div>
        ...
        <div class="img-dis">
            <a href="" target="_blank">
                <img class="img-border" src="img/onl7.png" alt="1" height="400" width="300"></img>
            </a>
            <br>
            <a href="" target="_blank" class="img-name">Áo croptop dạo phố vải cotton</a>
            <div class="gia_km_goc">
                <p class="gia_km">698,600₫</p>
                <p class="gia_goc">698,600₫</p>
            </div>
        ...
        <div class="img-dis">
            <a href="" target="_blank">
                <img class="img-border" src="img/onl8.png" alt="1" height="400" width="300"></img>
            </a>
            <br>
            <a href="" target="_blank" class="img-name">Áo kiểu dạo phố boi dáng</a>
            <div class="gia_km_goc">
                <p class="gia_km">698,600₫</p>
                <p class="gia_goc">698,600₫</p>
            </div>
    ...
    <div class = "style-div">
        <a href="" target="_blank">
            <p style="font-family: Arial; font-size: 70%" class = "see-more">Xem thêm</p>
        </a>
    </div>
    <!-- <br><br> -->
    <! DANH MỤC NỔI BẬT>
